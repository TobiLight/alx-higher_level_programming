...
class TestBase_Init(unittest.TestCase):
    ...
    def test_with_float_id(self):
        self.assertEqual(8.8, Base(8.8).id)

    def test_with_complex_id(self):
        self.assertEqual(complex(8), Base(complex(8)).id)

    def test_with_bool_id(self):
        self.assertEqual(True, Base(True).id)

    def test_with_set_id(self):
        self.assertEqual({1, 2, 3}, Base({1, 2, 3}).id)

    def test_with_frozenset_id(self):
        self.assertEqual(frozenset({1, 2, 3}), Base(frozenset({1, 2, 3})).id)

    def test_with_range_id(self):
        self.assertEqual(range(5), Base(range(5)).id)

    def test_with_bytes_id(self):
        self.assertEqual(b'CDQ', Base(b'CDQ').id)

    def test_with_bytearray_id(self):
        self.assertEqual(bytearray(b'azul'), Base(bytearray(b'azul')).id)

    def test_with_memoryview_id(self):
        self.assertEqual(memoryview(b'hennessey'),
                         Base(memoryview(b'hennessey')).id)

    def test_with_inf_id(self):
