...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Args:
            ...
            rect_2 (Rectanlge): An instance of class Rectangle

        Returns:
            Rectangle: The bggest class Rectangle based on the area
        """
    ...
    def square(cls, size=0):
        ...
        Args:
            size (int, optional): Size of a rectangle. Defaults to 0.
        """
